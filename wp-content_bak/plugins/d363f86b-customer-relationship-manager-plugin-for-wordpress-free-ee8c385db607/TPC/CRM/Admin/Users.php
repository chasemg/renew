...
class TPC_CRM_Admin_Users implements TPC_Interface_Runnable {
	...
	public function adminInit( ) {
		 ...
		 * Data Tables
		 */
		wp_register_script( 'jquery-datatable'			, TPC_CRM_URL . '/assets/js/jquery-datatable.min.js' );
		...
		wp_register_script( 'tpc-crm-admin-users-js'	, TPC_CRM_URL . '/assets/js/admin-users.js', array( 'jquery', 'jquery-select-chosen', 'jquery-bootstrap', 'bootstrap-datepicker', 'jquery-datatable', 'jquery-ui-autocomplete', 'jquery-ui-position' ) );
	}
