...
echo "<div id='paramsArray'>";
	echo '<input id="rcopia_portal_system_name" name="rcopia_portal_system_name" size="30" value="pvendornxunw">';
	echo '<input id="rcopia_practice_user_name" name="rcopia_practice_user_name" size="30" value="so95104">';
	echo '<input id="rcopia_user_id" name="rcopia_user_id" size="30" value="pproviderynftve">';
	echo '<input id="rcopia_user_external_id" name="rcopia_user_external_id" size="30" value="">';
	...
	echo '<input id="rcopia_patient_id" name="rcopia_patient_id" size="30" value="">';
	echo '<input id="rcopia_patient_system_name" name="rcopia_patient_system_name" size="30" value="pvendornxunw">';
	echo '<input id="rcopia_patient_external_id" name="rcopia_patient_external_id" size="30" value="test1234">';
	echo '<input type="hidden" id="time" name="time" size="30" value="fTime();">';
	echo '<input id="secret_key" name="secret_key" size="30" value="wiaofoh3" type="password" onmouseover="ShowPSW(this)" onmouseout="HidePSW(this)">';
	echo '<label>
		...
		n</label>';
	echo '<input id="logout_url" name="logout_url" size="30" value="">';
	echo '<label>
